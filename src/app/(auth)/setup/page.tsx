...
export default async function SetupPage() {
  ...
  return (
    <main className="min-h-dvh w-full bg-slate-50/50 flex flex-col items-center justify-center p-4 sm:p-6 antialiased overflow-hidden">
      ...
      >
        <span className="h-8 w-8 bg-brand-accent rounded-lg flex items-center justify-center text-white font-bold transition-transform group-hover:scale-105 shadow-sm">
          N
        </span>
        <span className="text-lg font-bold text-slate-900 group-hover:text-brand-hover transition-colors">
          ServiceDesk Pro
        </span>
      </Link>
