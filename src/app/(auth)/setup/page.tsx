...
export default async function SetupPage() {
  ...
  return (
    <main className="h-full bg-slate-50/50 flex flex-col items-center justify-center p-4 antialiased">
      ...
      >
        <span className="h-8 w-8 bg-teal-700 rounded-lg flex items-center justify-center text-white font-bold transition-transform group-hover:scale-105 shadow-sm">
          N
        </span>
